...
//	public Map<Integer,Collection<Product>> loadProductRecommendations()
//	{
//		
//		String sql = "SELECT * FROM madlib.assoc_rules( .25,            -- Support\n" + 
//		"	                                  .5,             -- Confidence\n" + 
...
//		
//		
//		sql= "select * from pivotalmarkets.assoc_rules order by support DESC";
//		
//		RowMapper<String> rowMapper = null;
//		
//		List<String> recommendedProductNames = this.jdbcTemplate.query(sql, rowMapper);
//		
//		if(recommendedProductNames == null || recommendedProductNames.isEmpty())
//			return null;
//		
//		Map<Integer,Collection<Product>> map = new HashMap<>();
//		for (String productName : recommendedProductNames)
//		{
//
//			if(map.get(product.getProductId()) == null)
//			{
//				map.put(product.getProductId(), new HashSet<>(Collections.singleton(product)));
//			}
//			else
//			{
//				map.get(product.getProductId()).add(product);
//			}
//		}
//		
//		return map;
